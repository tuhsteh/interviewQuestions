...
public class LabeledBlockExample {
	...
	static java.util.List<Integer> someNumbers = Arrays.asList(
			2,
			4,
			6,
			8,
	...
	public static void main(String args[]) {
		...
		long endBlockTime = System.currentTimeMillis();
		...
		System.out.println(String.format("Time to run static block for %d iterations is %,d milliseconds.", ITERATIONS, (endBlockTime - startBlockTime)));
		System.out.println(String.format("Time to run method call  for %d iterations is %,d milliseconds.", ITERATIONS, (endMethodTime - startMethodTime)));
	}

	public static int findThePrime() {
		for (int i : someNumbers) {
			if (i % 2 != 0) return i;
		}
		return 0;
